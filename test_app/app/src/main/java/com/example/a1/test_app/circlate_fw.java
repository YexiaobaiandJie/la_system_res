...
public class circlate_fw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circlate_fw);
        ...
        btn_cir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(circlate_fw.this,todo_af_list.class);
                startActivity(intent);
                //点击流转按钮，修改法人申请状态，提交至企发部主任
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Request request = new Request.Builder()
                                .url("http://192.168.191.1:3000/lp_submit_qf_master")
                                .post(body)
                                .build();
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch(lp_type){
                    case "单项投标":
                        Intent intent2 = new Intent(circlate_fw.this,LP_info_fw.class);
                        intent2.putExtra("item_id",lp_id);
                        startActivity(intent2);
                        break;
                    case "单项不投标":
                        Intent intent_n = new Intent(circlate_fw.this,LP_info_n.class);
                        intent_n.putExtra("item_id",lp_id);
