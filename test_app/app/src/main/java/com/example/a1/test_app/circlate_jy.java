...
public class circlate_jy extends AppCompatActivity {
  private String result;
  private String lp_id;
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_circlate_jy);
    ...
    btn_cir.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent = new Intent(circlate_jy.this,todo_af_list.class);
        startActivity(intent);
        //点击流转按钮，修改法人申请状态，提交至法务科
        new Thread(new Runnable() {
          ...
          public void run() {
            ...
            Request request = new Request.Builder()
                    .url("http://192.168.191.1:3000/lp_submit_fw")
                    .post(body)
                    .build();
    ...
    btn_back.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent intent2 = new Intent(circlate_jy.this,LP_info_jy.class);
