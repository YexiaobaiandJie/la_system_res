...
public class AF_result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_af_result);
    ...
    Handler mhandler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            //点击“提交至企发部”按钮，进入流转确认界面
            btn_qifa = findViewById(R.id.button6);
            btn_qifa.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    post_qifa(flsw_id);

                    Intent intent = new Intent(AF_result.this,AF_list.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.back_func:
                //在此界面点击返回功能界面，返回功能界面
                Intent intent_f = new Intent(AF_result.this,function_a.class);
                startActivity(intent_f);
                break;
            case R.id.exit:
                //在登录界面点击注销界面，返回登录界面
                Intent intent_l = new Intent(AF_result.this,FirstAcitivity.class);
    ...
    private Button btn_qifa;/**button6**/
