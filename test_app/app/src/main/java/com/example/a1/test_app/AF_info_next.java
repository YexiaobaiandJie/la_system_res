...
public class AF_info_next extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_af_info_next);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request request2 = new Request.Builder()
                        .url("http://192.168.191.1:3000/get_opinion_leader")
                        .post(body2)
                        .build();
                client.newCall(request2).enqueue(new Callback() {
                    ...
                    @Override
                    public void onResponse(Call call, Response response) throws IOException {
                        final String Op_info = response.body().string();
    ...
    private void initOPs2(){
        final ListView op_listview = this.findViewById(R.id.op_list_id);
        handler = new Handler(){
            @Override
            public void handleMessage(Message msg){
                super.handleMessage(msg);
                ...
                opinion_list_item_adapter_leader adapter = new opinion_list_item_adapter_leader(AF_info_next.this,R.layout.opinion_list_item_leader,op_list);
                op_listview.setAdapter(adapter);
                Utility.setListViewHeightBasedOnChildren(op_listview);

                //点击流转按钮流转
                btn_cir = findViewById(R.id.button5);
                btn_cir.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(AF_info_next.this,AF_list.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.back_func:
                //在此界面点击返回功能界面，返回功能界面
                Intent intent_f = new Intent(AF_info_next.this,function_b.class);
                startActivity(intent_f);
                break;
            case R.id.exit:
                //在登录界面点击注销界面，返回登录界面
                Intent intent_l = new Intent(AF_info_next.this,FirstAcitivity.class);
