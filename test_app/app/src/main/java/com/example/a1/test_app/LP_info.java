...
public class LP_info extends AppCompatActivity {
  private String userid;
  private String lp_id;
  private LP_all_info lp_info_ui;
  private String lp_tou;//根据法人申请是否投标确定流程
  private String lp_type = "单项投标";
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_lp_info);
  ...
  Handler mhandler = new Handler(){
    ...
    public void handleMessage(Message msg){
      ...
      btn_qifa1.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          Intent intent = new Intent(LP_info.this,circlate.class);
      ...
      btn_qifa2.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          Intent intent2 = new Intent(LP_info.this,circulate_back.class);
  ...
  public boolean onOptionsItemSelected(MenuItem item){
    switch(item.getItemId()){
      case R.id.back_func:
        //在此界面点击返回功能界面，返回功能界面
        Intent intent_f = new Intent(LP_info.this,function_b.class);
        startActivity(intent_f);
        break;
      case R.id.exit:
        //在登录界面点击注销界面，返回登录界面
        Intent intent_l = new Intent(LP_info.this,FirstAcitivity.class);
