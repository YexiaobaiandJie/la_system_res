...
public class circlate_zong extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_circlate_zong);
    ...
    btn_cir.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent = new Intent(circlate_zong.this,todo_af_list.class);
        startActivity(intent);
        //点击流转按钮，修改法人申请状态，提交至总经理
        new Thread(new Runnable() {
          ...
          public void run() {
            ...
            Request request = new Request.Builder()
                    .url("http://192.168.191.1:3000/lp_submit_z")
                    .post(body)
                    .build();
    ...
    btn_back.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        switch(lp_type){
          case "单项投标":
            Intent intent2 = new Intent(circlate_zong.this,LP_info_fg.class);
            intent2.putExtra("item_id",lp_id);
            startActivity(intent2);
            break;
          case "单项不投标":
            Intent intent2_n = new Intent(circlate_zong.this,LP_info_n_fg.class);
