...
public class AF_result3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_af_result3);
    ...
    Handler mhandler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            //点击“修改页面”跳至审批单创建页面，填充对应审批单信息，进行修改操作
            btn_change = findViewById(R.id.button6);
            btn_change.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(AF_result3.this,change_flsw.class);
                    intent.putExtra("flsw_name",flsw_info_ui.getFlsw_name());
                    intent.putExtra("flsw_content",flsw_info_ui.getFlsw_content());
                    intent.putExtra("flsw_type",flsw_info_ui.getFlsw_type());
                    intent.putExtra("flsw_remark",flsw_info_ui.getFlsw_remark());
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.back_func:
                //在此界面点击返回功能界面，返回功能界面
                Intent intent_f = new Intent(AF_result3.this,function_a.class);
                startActivity(intent_f);
                break;
            case R.id.exit:
                //在登录界面点击注销界面，返回登录界面
                Intent intent_l = new Intent(AF_result3.this,FirstAcitivity.class);
    ...
    private Button btn_change;/**button6**/
